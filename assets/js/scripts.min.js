...
function InlinePlayer() {
  ...
  var twurl = mydiv.getAttribute("data-thefile");
  ...
  this.events = {
    ...
    finish: function() {
      ...
      if (pl.config.playNext) {
        var nextLink = (pl.indexByURL[this._data.oLink.squrl]+1);
  ...
  this.handleClick = function(e) {
    ...
    var sURL = o.getAttribute('squrl');
    if (!o.squrl || (!sm.canPlayLink(o) && !self.classContains(o,self.playableClass)) || self.classContains(o,self.excludeClass)) {
      return true; // pass-thru for non-MP3/non-links
    }
    var soundURL = (o.squrl);
